...
<div id="container">
	<div id="header">
		User Task Form: SampleProcess2.Inspectcase
	</div>
	<div id="content">
		...
		<fieldset>
          ...
          <div class="div_checkbox">${task.priority}</div>
            	<label for="name">Comment</label>
            	<div class="div_checkbox">goutham comments</div>
            <div class="clear"></div>
          </fieldset>
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
				ID: ${persons.id}
									<#if persons.person??>
										Name: ${persons.person.givenName}<br/>
										Last Name: ${persons.person.givenName}
									</#if>
          </fieldset>
	</div>
	<div id="footer">
